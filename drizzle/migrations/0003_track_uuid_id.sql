...
INSERT INTO `__new_tracks`("id", "title", "description", "tags", "audio_file", "waveform_preview", "slug", "created_at") SELECT CAST("id" AS TEXT), "title", "description", "tags", "audio_file", "waveform_preview", "slug", "created_at" FROM `tracks`;--> statement-breakpoint
